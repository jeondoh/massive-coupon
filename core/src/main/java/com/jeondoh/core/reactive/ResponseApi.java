package com.jeondoh.core.reactive;
...
public class ResponseApi<T> {
    ...
    public static <T> ResponseApi<T> ok(ServerHttpResponse response, HttpStatus status) {
        response.setStatusCode(status);
        return new ResponseApi<>(status.value(), null);
    }

    public static <T> ResponseApi<T> ok(ServerHttpResponse response, HttpStatus status, String message) {
        response.setStatusCode(status);
    ...
    public static <T> ResponseApi<T> ok(T data, ServerHttpResponse response, HttpStatus status) {
        response.setStatusCode(status);
